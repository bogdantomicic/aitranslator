...
export default function SelectedLevel({setselectedLevelInParent}) {
  ...
  return (
    <div className="z-50 mb-5 shadow-sm desktop:w-1/3 mx-auto">
      <Listbox value={selectedLevel} onChange={handleLevelChange}>
        {({ open }) => (
          <>
            <Listbox.Label className="block text-sm desktop:text-lg font-medium leading-6 text-gray-900">
              Izaberi nivo znanja Engleskog jezika!
            </Listbox.Label>
            <div className="relative mt-2">
              <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600 text-sm sm:text-lg sm:leading-6 ">
              ...
              >
                  ...
                  <Listbox.Options className=" text-start absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text:sm desktop:text-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text:lg text-sm">
